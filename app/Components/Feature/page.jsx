    ...
    const featuresData = [
        {
            ...
            description: "Our AI agents intelligently automate repetitive workflows, monitor operations in real time, and provide contextual insights that help teams make faster, smarter decisions. Designed for scalability, they reduce manual effort while accelerating measurable business growth."
        },
        {
            ...
            title: "Smarter Operations, Faster Growth",
            description: "From task automation to collaborative intelligence, our AI-powered system works seamlessly behind the scenes to optimize processes, eliminate bottlenecks, and enhance productivity — enabling teams to focus on strategy instead of busywork."
        },
        {
            ...
            description: "Powered by advanced machine learning and intelligent orchestration, our AI agents streamline operations, improve visibility, and create a foundation for sustainable, long-term growth in fast-moving environments."
        },
        {
            ...
            title: "Scalable Automation Infrastructure",
            description: "By combining automation, monitoring, and contextual awareness, our AI solutions transform complex workflows into efficient, scalable systems that empower businesses to operate smarter and grow faster."
        },
        {
            ...
            title: "Real-Time Intelligence & Optimization",
            description: "Our platform leverages intelligent automation to handle repetitive tasks, deliver real-time performance insights, and enable seamless collaboration — driving efficiency and unlocking new growth opportunities."
        },
        {
